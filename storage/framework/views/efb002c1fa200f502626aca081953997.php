...
<section class="custom-class bg-brand-orange text-white position-relative overflow-hidden"
         style="background-image:url('<?php echo e(asset('public/' . ltrim(parse_url($heroImageUrl, PHP_URL_PATH), '/'))); ?>'); background-size:cover; background-position:center right;">
...
<section class="container py-5">
    ...
    <form method="GET" action="<?php echo e(route('home')); ?>" class="mx-auto mb-4" style="max-width:640px;" data-campaign-search>
    ...
    <div class="custom-filter-btn d-flex flex-wrap justify-content-center gap-2 mb-4">
        <a href="<?php echo e(route('home', array_filter(['search' => $search]))); ?>" data-category=""
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('home', array_filter(['category' => $cat['value'], 'search' => $search]))); ?>" data-category="<?php echo e($cat['value']); ?>"
    ...
    <div id="campaign-results">
        <?php echo $__env->make('public._campaigns', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</section>
...
<section class="bg-brand-orange text-white py-5 position-relative newsletter-banner">
    ...
    <div class="newsletter-ribbon-left d-none d-md-block" aria-hidden="true">
        ...
        <img src=<?php echo e(asset('/public/images/mega-sale.png')); ?> alt="mega-sale" class="megasale">
    </div>

    
    <div class="newsletter-ribbon-right d-none d-md-block" aria-hidden="true">
       <img src=<?php echo e(asset('/public/images/special-offer.png')); ?> alt="special-offer" class="special-offer">
    </div>
        ...
        <div class="custom-right col-lg-7">
            <div class="d-flex align-items-start mb-4">
                ...
                <span class="bg-light text-secondary rounded-circle d-inline-flex align-items-center justify-content-center flex-shrink-0 me-3" style="width:56px; height:56px;">
                    <img src=<?php echo e(asset('/public/images/search.png')); ?> alt="search">
                </span>
                <div>
            ...
            <div class="d-flex align-items-start mb-4">
                ...
                <span class="bg-light text-secondary rounded-circle d-inline-flex align-items-center justify-content-center flex-shrink-0 me-3" style="width:56px; height:56px;">
                    <img src=<?php echo e(asset('/public/images/qr.png')); ?> alt="qr">
                </span>
                <div>
            ...
            <div class="d-flex align-items-start">
                ...
                <span class="bg-light text-secondary rounded-circle d-inline-flex align-items-center justify-content-center flex-shrink-0 me-3" style="width:56px; height:56px;">
                    <img src=<?php echo e(asset('/public/images/ticket.png')); ?> alt="ticket">
                </span>
                <div>
...
(function () {
    ...
    var state = {
        category: <?php echo json_encode($activeCategory, 15, 512) ?> || '',
