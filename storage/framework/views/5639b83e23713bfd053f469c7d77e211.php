                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $advertisers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertiser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="<?php echo e(route('admin.advertisers.show', $advertiser)); ?>" class="btn btn-sm btn-outline-secondary">View</a>
                                <a href="<?php echo e(route('admin.advertisers.edit', $advertiser)); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\adcoupon-platform\resources\views/admin/advertisers/index.blade.php ENDPATH**/ ?>