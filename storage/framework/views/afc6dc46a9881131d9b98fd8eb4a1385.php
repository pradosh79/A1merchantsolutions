...
<head>
    <meta charset="UTF-8">
    <title>Admin Login - <?php echo e(config('company.name')); ?></title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-8">
            <div class="logoclass text-center mb-3">
                <img src="<?php echo e(asset(ltrim(config('company.logo'), '/'))); ?>" alt="<?php echo e(config('company.name')); ?>">
            </div>
            <div class="card custom-card">
                <div class="text-center" style="border-bottom:0;">
                    <!--<h5 class="mb-0"><?php echo e(config('company.name')); ?> Admin</h5>-->
...
<?php /**PATH /home/u533806958/domains/a1merchantsolutions.triviio.com/public_html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>