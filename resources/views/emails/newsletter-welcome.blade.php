            ...
            <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,0.1);">
                ...
                <tr>
                    <td style="padding:24px; color:#333;">
                        ...
                        <p>Thanks for joining the {{ config('company.name') }} deals list. You'll be the first to hear about exclusive discounts, limited-time offers, QR deals, and cashback.</p>
                        <p style="text-align:center; margin:28px 0;">
                            <a href="{{ config('app.url') }}" style="background:#f96a09; color:#fff; text-decoration:none; padding:12px 24px; border-radius:6px; font-weight:bold;">Browse Today's Deals</a>
                        </p>
                        <p style="font-size:13px; color:#999;">You're receiving this because {{ $subscriber->email }} was subscribed on our website.</p>
                    </td>
                </tr>
                <tr>
