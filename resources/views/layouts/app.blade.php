...
<head>
    ...
    <title>@yield('title', 'Admin') - {{ config('company.name') }}</title>
...
<header class="navbar navbar-expand-lg navbar-dark bg-dark px-3">
    <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.dashboard') }}">
        <span class="logo-badge p-1 me-2">
            <img src="{{ asset(ltrim(config('company.logo'), '/')) }}" alt="{{ config('company.name') }}" height="32">
        </span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="adminNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.advertisers.index') }}">Advertisers</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.offers.index') }}">Offers</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.screens.index') }}">Screens</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.claims.index') }}">Claims</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.analytics.index') }}">Analytics</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.logs.coupons') }}">Coupon Logs</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.logs.redemptions') }}">Redemption Logs</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.homepage-settings.edit') }}">Homepage Settings</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.newsletter.index') }}">Newsletter</a></li>
        </ul>
        @auth
...
<footer class="border-top bg-white text-center text-muted py-3 mt-4">
    <small>{{ config('company.name') }} Admin &middot; &copy; {{ date('Y') }}</small>
</footer>
